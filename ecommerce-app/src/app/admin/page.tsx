          ...
          <div className="space-y-10">
            <div className="bg-white rounded-[3rem] p-8 md:p-12 premium-shadow border border-slate-100 flex flex-col md:flex-row items-center gap-8 justify-between relative overflow-hidden">
              ...
              <div className="flex gap-4 relative z-10">
                <Link 
                  href="/admin/logs"
                  className="h-14 px-6 rounded-2xl bg-slate-50 flex items-center gap-3 border border-slate-100 hover:bg-white hover:shadow-xl transition-all group"
                >
                  <div className="flex flex-col items-start">
                    <span className="text-[8px] font-black uppercase tracking-widest text-slate-400">System Logs</span>
                    <span className="text-[10px] font-black uppercase tracking-widest text-slate-900">View Audit</span>
                  </div>
                  <svg className="h-4 w-4 text-slate-400 group-hover:text-emerald-600 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
